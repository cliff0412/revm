use database::{CacheDB, Database, DatabaseCommit, DatabaseRef, EmptyDB};
use futures::channel::mpsc::Sender;
use primitives::{Address, HashMap as rHashMap, B256, KECCAK_EMPTY, U256};
...
impl DatabaseCommit for ForkDB {
    fn commit(&mut self, changes: rHashMap<Address, Account>) {
